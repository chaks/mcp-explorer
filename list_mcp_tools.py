...
# Global flag controlled by CLI options
SHOW_DETAILED = False
                    ...
                    if not endpoint_set and not data_content.startswith("{"):
                        ...
                        try:
                            ...
                            if "result" in payload and "tools" in payload["result"]:
                                ...
                                # Apply filtering based on command line options
                                if SHOW_DETAILED:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--detailed", 
        action="store_true", 
        help="Include full tool descriptions, input schemas, and argument specifications."
    )
